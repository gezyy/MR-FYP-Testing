...
namespace XCharts.Example
{
    ...
    {
        LineChart chart;
        ChartTextController textController;

        void Awake()
        {
            chart = gameObject.GetComponent<LineChart>();
            textController = FindObjectOfType<ChartTextController>(); // 找到Panel上挂载的 ChartTextController
            ...
            chart.onSerieEnter = textController.OnSerieEnter;
            chart.onSerieExit = textController.OnSerieExit;
